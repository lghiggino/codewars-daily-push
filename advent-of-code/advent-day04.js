console.log("day 4 is on")

const fullData = document.querySelector(".full-data").textContent;

//fullData is a string
// find \n\n on the string
// split that into a substring and store it multiple times
...
// function passportCheckerIgnoreCid(string){
//     let array = string.split("\n\n")
//     let count = 0;
//     for (i = 0; i < array.length; i++){
//         if (array[i].includes("byr:") && 
//             array[i].includes("iyr:") &&
//             array[i].includes("eyr:") &&
//             array[i].includes("hgt:") &&
//             array[i].includes("hcl:") &&
//             array[i].includes("ecl:") &&
//             array[i].includes("pid:")){
//             count++
//         }
//     }
//     console.log(count)
