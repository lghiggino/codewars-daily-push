console.log("javascript advent day 2 is on");
...
// console.log(dataset[1][0].trim())
// console.log(dataset[1][1].trim())
// console.log(dataset[1][2].trim())

function passwordChecker(dataset){
    let count = 0
    for (i = 0; i < dataset.length; i++){
        let passwordAmount = dataset[i][0].trim();
        let passwordAmounMinimum = Number.parseInt(passwordAmount.split("-")[0]);
        let passworAmountMaximum = Number.parseInt(passwordAmount.split("-")[1]);
        let passwordKeyDigit = dataset[i][1].trim();
        let passwordString = dataset[i][2].trim();
        let passwordArray = passwordString.split("");
        //console.log(passwordArray)
        let singleCharacterCount = passwordArray.reduce(function(obj, item){
            if(!obj[item]){
                obj[item] = 0;
            }
            obj[item]++;
        ...
        //console.log(singleCharacterCount, passwordKeyDigit, singleCharacterCount[passwordKeyDigit], passwordAmounMinimum, passworAmountMaximum)
        if ((singleCharacterCount[passwordKeyDigit] >= passwordAmounMinimum) && (singleCharacterCount[passwordKeyDigit] <= passworAmountMaximum)){
            count++
        }
...
//passwordChecker (dataset)


function passwordCheckerCharPlace(dataset){
    let count = 0
    for (i = 0; i < dataset.length; i++){
        let passwordAmount = dataset[i][0].trim();
        let passwordAmounMinimumPosition = Number.parseInt(passwordAmount.split("-")[0])-1;
        let passworAmountMaximumPosition = Number.parseInt(passwordAmount.split("-")[1])-1;
        let passwordKeyDigit = dataset[i][1].trim();
        let passwordString = dataset[i][2].trim();
        let passwordArray = passwordString.split("");
        // console.log(passwordArray)
        // console.log(`At position ${passwordAmounMinimumPosition}:`, passwordArray[passwordAmounMinimumPosition], "expected is:", passwordKeyDigit)
        // console.log(`At position ${passworAmountMaximumPosition}:`, passwordArray[passworAmountMaximumPosition], "expected is:", passwordKeyDigit)
        let a = passwordArray[passwordAmounMinimumPosition] == passwordKeyDigit;
        let b = passwordArray[passworAmountMaximumPosition] == passwordKeyDigit;
        console.log("rodada", i, "expected", passwordKeyDigit, passwordArray[passwordAmounMinimumPosition], passwordArray[passworAmountMaximumPosition],  a, b)
...
passwordCheckerCharPlace(dataset)
